...
class ProfilePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    deletePic() async {
      await BlocProvider.of<ProfilepicCubit>(context).deletePic(userid);
    }
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        onRefresh: () async {
          await BlocProvider.of<PostsCubit>(context).getAllPosts(userid);
        },
        child: ListView(
          children: [
            const SizedBox(
            ...
            Row(
              ...
              children: [
                BlocConsumer<ProfilepicCubit, ProfilepicState>(
                  listener: (context, state) {
                    if (state is ProfilepicDeleteDone) {
                      Navigator.of(context).pop();
                    }

                    if (state is ProfilepicDeleteFailure) {
            ...
            Padding(
              ...
              child: Text(
                ...
                style:
                    const TextStyle(fontSize: 20, color: MyColors.secondary1),
              ),
            ),
