  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        ...
        child: BlocBuilder<PostsothersCubit, PostsothersState>(
          builder: (context, state) {
                    ...
                    children: [
                      ...
                      BlocBuilder<FollowCubit, FollowState>(
                        ...
                        if (state is FollowAddDone ||
                            state is FollowRemoveFailure) {
                          isFollowed = "1";
                        }
                        if (state is FollowRemoveDone ||
                            state is FollowAddFailure) {
                          isFollowed = "0";
                        }
                          ...
                          onPressed: () async {
                            if (isFollowed == "0") {
                              await BlocProvider.of<FollowCubit>(context)
                                  .followAddTry(
                                      mainid, widget.usersId.toString());
                              isFollowed = "1";
            ...
            return const LoadingScreen(width: 100);
          },
        ),
      ),
    );
